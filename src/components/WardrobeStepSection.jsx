...
import WardrobePlanningStorage from "./WardrobePlanningStorage";

export default function WardrobeStepSection() {
  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center px-4 my-10 mx-2">
        <h1 className=" text-4xl  font-semibold font-Lato text-center my-2">
          Our Process for Modular Wardrobe
        </h1>
        <HeartDesignDivider color={"orange-500"} />

        <div className="flex flex-col md:flex-row justify-center mt-5 items-center mx-10 w-full h-max md:h-28 gap-1">
          <button
            onClick={() => setSection(1)}
            className={` flex flex-row justify-center   font-Lato  items-center hover:bg-orange-500 hover:text-white  border border-neutal-500  w-full h-full gap-2 ${
        ...
        {section === 1 ? (
          <div className="flex flex-col justify-center items-center gap-2 my-12 px-5  sm:px-14 md:px-32 xl:px-64">
            ...
            <p className=" mt-5 text-neutral-700 leading-snug md:text-lg">
              At Kitchen décor, we make sure to offer you a modular wardrobe
              that caters to your needs and requirements to the fullest. This is
              done by carefully understanding your expectations collected
              through the Kitchen décor questionnaire filled by you. This step
              facilitates effective communication and sets a strong foundation
              for the further process of modern wardrobe designing.
            </p>
          </div>
        ) : section === 2 ? (
          <div className="flex flex-col justify-center items-center gap-2  px-5  sm:px-14 md:px-32 xl:px-64">
            ...
            <HeartDesignDivider color={"orange-500"} />
            <p className=" mt-5 text-neutral-700 leading-snug md:text-lg">
              The application of ergonomics for designing a modern wardrobe will
              transform your overall experience with a particular space. From
              the depth of the wall unit to organizing storage spaces for your
              modular wardrobe, Kitchen décor will present you with a smartly
              and efficiently designed luxury wardrobe.
            </p>

            <div className=" mt-8 ">
              <div className="grid grid-cols-1 md:grid-cols-1 gap-5 md:gap-3 ">
          ...
          <div className="flex flex-col justify-center items-center gap-2 my-12 px-5  sm:px-14 md:px-32 xl:px-64 ">
            ...
            <HeartDesignDivider color={"orange-500"} />
            <p className=" mt-5 text-neutral-700 leading-snug md:text-lg">
              A perfectly modular wardrobe design has enough storage space, and
              is compact as well as good-looking. Wardrobes by Kitchen décor,
              adds one more feature to your wardrobes which makes it more
              user-friendly and comfortable. So now no more unnecessary bending,
              stretching, or bumping. <br />
              To make your “getting ready” process and life even simpler and
              easier, Kitchen décor introduces the 3 zone Design Principle to
              your modern wardrobe design. <br />
              <span className="text-black font-semibold">
                In this process, we divide your wardrobe into 3 zones.
              </span>
              <br />
              <span className="text-black font-semibold">Daily zone: </span>
              This part of the wardrobe shall carry all your most used clothes
              and necessities. This section will be placed in a way which is
              easily accessible and avoids any bending or stretching on your
              part
              <br />
              <span className="text-black font-semibold">Often zone:</span>
              This zone will bear all the essentials necessities that you may
              use on a daily basis.
              <br />
              <span className="text-black font-semibold">Rare zone: </span>
              This section of the cupboard is the one that has the least visits
              from you. It shall include all your party wears, accessories and
              things that you seldom use. <br />
            </p>
          </div>
        ) : section === 4 ? (
          <div className="flex flex-col justify-center items-center gap-2 px-5  sm:px-14 md:px-32 xl:px-64 ">
          ...
          <div className="flex flex-col justify-center items-center gap-2 my-12 px-5  sm:px-14 md:px-32 xl:px-64">
            ...
            <HeartDesignDivider color={"orange-500"} />
            <p className=" mt-5 text-neutral-700 leading-snug md:text-lg">
              Along with having huge storage space and being perfectly
              organized, your wardrobes must possess an aesthetic look with a
              well-designed appearance. At Kitchen décor, we create modular
              wardrobes that are classy, finely crafted, and rightly coordinated
              in terms of color combination and texture. So enjoy a luxury
              wardrobe that has got it all. Star Features of our Wardrobes.
            </p>
          </div>
        ) : (
          ""
